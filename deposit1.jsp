...
<div id="header">
	<h1>BANK<span class="style1"></span></h1>
...
<tr >
	<td width="300" valign="top" style="border-right:#666666 1px dotted;">
    	<div id="services"><h1>Services</h1><br>
		    <ul>
        	<li><a href="#">www.bank.com</a></li>
            <li><a href="#">www.bankindia.com </a></li>
            <li><a href="#">www.bank.com/forum.jsp</a></li>
            </ul>
    ...
    <td width="1200" valign="top">
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form name=F1 onSubmit="return dil(this)" action="deposit.jsp" >
					...
					<tr><td></td><td><input type="submit" value="Submit" onclick=callalert()/>
     ...
     <td width="299" valign="top">
    	<div id="welcome" style="border-right:#666666 1px dotted;"><h1>Welcome</h1><br>
		    ...
		    <p>Each people plan their site layouts depending upon their business type.</p>
